      ...
      <div class="login-container" id="container">
        <div class="form-container sign-up-container">
          <form action="#">
            ...
            <div class="social-container">
              <a
                href="https://www.instagram.com/zaidirfankhan/?hl=en"
                target="_blank"
                class="social"
              ...
              ></a>
              <a
                href="https://www.linkedin.com/in/zaid-irfan-khan-9a4b964b/"
                target="_blank"
                class="social"
        ...
        <div class="form-container sign-in-container">
          <form @submit.prevent v-if="is_forgot">
            ...
            <a
              href="#"
              @click.prevent="is_forgot = false"
              style="color: #212121"
              >Login</a
            >
            <button class="si mt-3" @click="loginForgot">
              {{ isLoging ? "Submit..." : "Submit" }}
            </button>
          </form>
          ...
          <form @submit.prevent v-else>
            ...
            <a
              href="#"
              target="_blank"
              @click.prevent="is_forgot = true"
              style="color: #212121"
              >I Forgot my Password</a
            >
            <button class="si mt-3" @click="loginuser">
              {{ isLoging ? "Sign In..." : "Sign In" }}
            </button>
          </form>
        </div>
        <q></q>
...
export default {
  ...
  methods: {
    ...
    async loginForgot() {
      ...
      this.isLoging = true;
      try {
        await this.$axios.post("/organization/forgot/password", {
